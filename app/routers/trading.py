...
from ..core.responses import TradingControlResponse, TradingStatusResponse
...
@router.get("/{user_id}/trading", response_model=TradingStatusResponse)
...
@router.post("/{user_id}/trading", response_model=TradingControlResponse)
...
@router.delete("/{user_id}/trading", response_model=TradingControlResponse)
