...
Pure computation — no I/O, no infrastructure dependencies.
Takes OHLCV arrays, returns indicator values.

Source: services/strategy/src/technical_indicators.py (moved as-is, already pure)
"""
...
def format_indicators_summary(indicators: TechnicalIndicators) -> str:
    """Format indicators as human-readable summary for Claude prompts.
